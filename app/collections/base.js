define(function(require) {
  ...
  Collection.prototype.initialize = function(options) {
    ...
    this.resource = connection.resource('api');
    ...
    that.resource.subscribe(name + ':delete', function(data) {
  ...
  Collection.prototype.sync = function(method, model, options) {
    ...
    options.data = _.extend(options.data || {}, {model: (this.name || this.model.prototype.name)});
